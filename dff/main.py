...
from .helpers import construct_social_graph, save_photos
...
if __name__ == '__main__':
    ...
    logged_in = login(driver, conf['base_url'], conf['auth']['fb_user'],
        conf['auth']['fb_pass'], args.user_folder)
    ...
    if(logged_in):
        ...
        save_photos(friends_data, join_or_make(args.user_folder, 'friends_photos'), 
            suffix='.thumb')
        ...
        save_photos(photos, join_or_make(args.user_folder, 'photos'))
    else:
